...
__published:	// IDE-managed Components
    ...
    void __fastcall NewSensorClick(TObject *Sender);
    void __fastcall RzButton1Click(TObject *Sender);
    void __fastcall FrameiPipe1MouseDown(TObject *Sender,
...
public:		// User declarations
    ...
    void __fastcall AddSensor(int Left);
    void __fastcall FreeSensors();
};
//---------------------------------------------------------------------------
extern PACKAGE TMainForm *MainForm;
extern String password;
extern int motorCount;
extern TQueue* sendQueue;
